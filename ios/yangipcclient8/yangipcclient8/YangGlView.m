...
-(void)layoutSubviews{
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        //把数据显示在这个视窗上
        glViewport(1, 1, self.bounds.size.width*m_viewScale - 2, self.bounds.size.height*m_viewScale - 2);
    });
}
...
-(void)render{
    ...
    //把数据显示在这个视窗上
    glViewport(1, 1, size.width * m_viewScale -2, size.height * m_viewScale -2);
